...
MediaWrapper.prototype = {
    ...
    eventsBind: function eventsBind(e) {
        var _this = this;
        ...
        $e.on('click', function (e) {
            ...
            _this.onFocus && _this.onFocus($e);
            console.log('1111111');
            e.stopPropagation();
        });
        $('body').on('click', function () {
            $e.removeClass('is-active');
            _this.onBlur && _this.onBlur($e);
        });
    }
};
                    ...
                    fn: function fn() {
                        ...
                        if (val) {
                            ...
                            var videoWithWrapper = new MediaWrapper({
                                contentHtml: htmlStr,
                                contentType: 'video',
                                maxHeight: _this.editor.config.youbute.height,
                                maxWidth: _this.editor.config.youbute.width,
                            ...
                            _this._insert(videoWithWrapper.generateDom());
                        }
