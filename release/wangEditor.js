...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        $textContainerElem.addClass('w-e-text-container' + ' ' + config$$1.locale || 'locale-zh');
