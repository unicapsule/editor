...
ContentWrapper.prototype = {
    generateHtml: function generateHtml() {
        ...
        var htmlStrArr = ['<figure contenteditable="false">', '<div class="me-media-container" style="' + style + '">', '<div class="me-media-container--placeholder"></div>', '<div class="me-media-container--content">' + this.contentHtml + '</div>', '</div>'];
                ...
                events: [{
                    ...
                    fn: function fn() {
                        ...
                        if (val) {
                            ...
                            var htmlStr = '<iframe width="100%" height="' + _this.videoHeight + '" src="' + embedLink + '" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
                            var videoWithWrapper = new ContentWrapper({
                                contentHtml: htmlStr,
                                contentType: 'video',
                                maxHeight: _this.videoHeight,
                                maxWidth: _this.videoWidth
                            });
                            _this._insert(videoWithWrapper.generateHtml());
                        }
